...
El cambio, fusión o progreso, todos inducen a la evolución. Con la remediación, el medio analógico se ha vuelto digital, ejecutando su función en un metamedio-dispositivo. Por consiguiente, resulta inevitable el siguiente paso - la **hibridación**. El momento en que los medios comienzan a combinarse y fusionarse.
...
![Cultura Digital](https://github.com/basia-niemiec/PEC3_Manovich_Reloaded/blob/main/duolingo_mov.png) 
...
En toda la aplicación presentamos la **combinación de las técnicas de interacción con interfaz multitáctil**, que nos permite interactuar con cualquier elemento en la pantalla.

**Duolingo** se basa principalmente en el aprendizaje educativo y divertido - **gamificación**: la combinación de **aprendizaje con características propias de un juego** basado en motivación utilizando métodos como: Rachas, vida limitadas, ligas, contadores de experiencia, lo que estimula la competición y ganas de aprender.
...
>
> **Que te expliquen paso a paso donde te has equivocado.**
...
PhotoMath es una aplicación de gran utilidad para los estudiantes de todas las edades, especialmente por su **combinación de sencillez en la búsqueda** de la solución a su problema, por **la rapidez** de los detalles relacionados con los **resultados** y la forma de su presentación, destacando su sencillo y fácil manejo. 

------

## **Conclusión**

La hibridación de los medios es un avance importante en todas las áreas, no solo en la educación. Nos brinda unas oportunidades imaginables. Simplemente, comparando los medios para estudiar de hace 30 años con los de actualidad, son abrumadores. Cada vez son más complejos con sus múltiples funciones y a la vez más sencillos en su manipulación. 
